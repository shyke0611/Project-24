...
const sampleMessages: Message[] = [
  {
    id: "1",
    text: "Hello Clara, how are you today?",
    sender: "user",
  ...
  {
    id: "3",
    text: "Can you remind me to take my medication at 3pm?",
    sender: "user",
    timestamp: new Date(new Date().setHours(new Date().getHours() - 1)),
  },
  {
    id: "4",
    text: "Of course! I've set a reminder for your medication at 3:00 PM today. I'll notify you when it's time.",
    sender: "assistant",
    timestamp: new Date(new Date().setHours(new Date().getHours() - 1)),
  },
  {
    id: "5",
    text: "Thank you Clara!",
    sender: "user",
        ...
        <View style={styles.inputArea}>
          {chatState === ChatState.TYPING ? (
            <View style={styles.typingContainer}>
              ...
              />
              <TouchableOpacity onPress={handleCloseTyping} style={styles.closeButton}>
